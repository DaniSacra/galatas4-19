...
class EpisodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create episode" do
    assert_difference('Episode.count') do
      post episodes_url, params: { episode: { description: @episode.description, launch: @episode.launch, title: @episode.title } }
    end
  ...
  test "should update episode" do
    patch episode_url(@episode), params: { episode: { description: @episode.description, launch: @episode.launch, title: @episode.title } }
